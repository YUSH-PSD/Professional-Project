...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="relative h-64 md:h-80 bg-[#132340] flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 border rounded-lg transition-all ${errors.subject ? 'border-red-300 focus:ring-red-300' : 'border-gray-300 focus:ring-[#d1c09a]'} focus:outline-none focus:ring-2`}
                    >
                ...
                <button
                  ...
                  className={`w-full md:w-auto px-8 py-3 text-white font-semibold rounded-lg transition-all duration-300 hover:shadow-lg ${isSubmitting ? 'bg-gray-400 cursor-not-allowed' : 'bg-[#132340] hover:bg-[#1a2d4a]'}`}
                >
                  {isSubmitting ? (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-2xl p-6">
              ...
              <div className="space-y-4">
                <a href="https://maps.google.com/?q=Battisputali+Road+Kathmandu" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 group cursor-pointer">
                  <div className="w-10 h-10 bg-[#d1c09a] rounded-full flex items-center justify-center shrink-0 group-hover:bg-[#c4a882] transition-colors">
                    <svg className="w-5 h-5 text-[#132340]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-[#d1c09a] rounded-full flex items-center justify-center shrink-0">
                    <svg className="w-5 h-5 text-[#132340]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <div>
                    <p className="font-medium text-[#132340]">Working Hours</p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Link to="/booking" className="text-center py-3 bg-[#d1c09a] text-[#132340] font-semibold rounded-lg hover:bg-[#c4a882] transition-all">
                Book Now
              </Link>
              <a href="tel:+97714579488" className="text-center py-3 border-2 border-[#132340] text-[#132340] font-semibold rounded-lg hover:bg-[#132340] hover:text-white transition-all">
                Call Us
              </a>
            </div>
